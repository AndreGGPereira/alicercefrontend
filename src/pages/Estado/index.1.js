...
export default class Estado extends React.Component{
    ...
    findSelectedCarIndex() {
        return this.estado.indexOf(this.state.selectedCar);
    }
  ...
  //  this.state.Nome         = teste.nomeimport React from 'react'
import Sidebar from '../../components/sidebar/'
            ...
            <div className="p-grid">
                ...
                <main className="p-col-12 p-lg-9 page">
                    ...
                    <Messages ref={(el) => this.messages = el}></Messages>
                        ...
                        <DataTable selectionMode="single" onSelectionChange={e => this.setState({selectedCar: e.value})} 
                        selection={this.Estado.ID} value={this.Estado.Estados}   onRowSelect={this.selecionar} paginator={true} rows={10}>
